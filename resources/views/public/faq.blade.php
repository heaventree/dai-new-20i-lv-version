...
$fallbackFaqs = [
    ...
    {{-- ORIGINAL: ['category'=>'General Questions','q'=>'How much does it cost?','a'=>'The standard fee is €' . $fee . '. Payment instructions are provided during the online booking process.'], --}}
    ['category'=>'General Questions','q'=>'How much does it cost and what is included?','a'=>'The assessment fee is €' . $fee . '. This includes the full on-road driving assessment, a detailed written report, and recommendations for your Healthcare Professional. Please check our cancellation policy before booking.'],
    ['category'=>'General Questions','q'=>'What if I decide not to go ahead?','a'=>'Please let us know as soon as possible if you wish to cancel or reschedule your assessment. Please note a cancellation fee of €55.00 is payable if a driving assessment is cancelled with less than 48 hours notice. An administration fee may apply to assessments cancelled more than 48 hours before the scheduled assessment date.'],
    ['category'=>'General Questions','q'=>'Will this affect my driving licence or will DAI report me to the NDLS?','a'=>'DAI does not report directly to the NDLS. The final decision about your licence rests with your referring Healthcare Professional and the NDLS, not DAI. Our role is to provide an objective, professional assessment. Our goal is always to support safe driving where possible.'],
    ['category'=>'General Questions','q'=>'Is it a pass or fail test?','a'=>'No — it is not a pass or fail test. It is a professional assessment that evaluates your current driving ability. The outcome is a detailed report with recommendations, not a pass or fail result.'],
    ...
    ['category'=>'Assessment Process','q'=>'Whose car is used during the assessment?','a'=>'Your own car is used during the assessment. Please ensure it is taxed, insured, and has a valid NCT.'],
    ...
    {{-- ORIGINAL: What should I bring on the day of the assessment? --}}
    ['category'=>'Before Your Assessment','q'=>'What do I need to bring?','a'=>'Please bring your valid driving licence, your Eircode, and confirmation of your current motor insurance, NCT, and motor tax. These details will also be required during the booking process.'],
