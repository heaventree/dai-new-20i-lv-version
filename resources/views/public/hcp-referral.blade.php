    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-10 items-start">
            ...
            <aside class="space-y-6">
                ...
                @foreach([
                    ['Secure Handling','Data is encrypted and stored in compliance with medical privacy standards.','M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'],
                ...
                <form method="POST" action="{{ route('hcp-referral.submit') }}" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <label class="text-sm font-medium text-gray-800">Alternative Contact Details</label>
